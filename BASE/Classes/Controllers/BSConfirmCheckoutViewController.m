...
- (void)viewDidLoad
{
    ...
    //グーグルアナリティクス
    self.screenName = @"confirmCheckout";
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [manager POST:[url absoluteString] parameters:orderInfo success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
- (void)decision:(id)sender{
    ...
    [tracker send:[[GAIDictionaryBuilder createEventWithCategory:@"BSConfirmCheckoutViewController"
                                                          action:@"decision"
                                                           label:nil
                                                           value:nil] build]];
    ...
    [manager POST:[url absoluteString] parameters:orderInfo success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if (paypalErrormessage) {
            ...
            [tracker send:[[GAIDictionaryBuilder createEventWithCategory:@"BSConfirmCheckoutViewController"
                                                                  action:@"failDecision:paypalError"
                                                                   label:nil
                                                                   value:nil] build]];
