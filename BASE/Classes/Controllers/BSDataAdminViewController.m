...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[BSSellerAPIClient sharedClient] getOrderHeadersOrdersWithSessionId:[BSUserManager sharedManager].sessionId completion:^(NSDictionary *results, NSError *error) {
        
        NSLog(@"getOrderHeadersOrdersWithSessionId: %@", results);
        ordersArray = [results valueForKeyPath:@"result"];
    ...
    [[BSSellerAPIClient sharedClient] getDataDispatchStatusWithSessionId:[BSUserManager sharedManager].sessionId completion:^(NSDictionary *results, NSError *error) {
        ...
        NSLog(@"getDataDispatchStatusWithSessionId:%@",dispatchResult1);
