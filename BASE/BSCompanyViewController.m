...
#import "BSCompanyViewController.h"

@interface BSCompanyViewController ()

@end

@implementation BSCompanyViewController
...
- (void)viewDidLoad
{
    ...
    //グーグルアナリティクス
    self.trackedViewName = @"aboutCompany";
    ...
    NSURL *url = [NSURL URLWithString:@"http://thebase.in/pages/term1.html"];
    ...
    UINavigationItem *navItem = [[UINavigationItem alloc] initWithTitle:@"会社概要"];
