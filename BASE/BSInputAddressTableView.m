...
-(void)importAddressInfo:(NSString*)zipcode{
    ...
    NSLog(@"zipcodezipcodezipcodezipcodezipcode:%@",zipcode);
    NSString *urlString = [NSString stringWithFormat:@"http://api.zipaddress.net/?zipcode=%@",zipcode];
    ...
    AFJSONRequestOperation *operation = [AFJSONRequestOperation JSONRequestOperationWithRequest:request success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
        NSLog(@"result: %@", JSON);
        prefectureTextField.text = [JSON valueForKeyPath:@"data.pref"];
        addressTextField.text = [JSON valueForKeyPath:@"data.address"];
