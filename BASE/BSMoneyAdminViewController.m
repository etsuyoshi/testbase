...
- (void)setMoneyInfo
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/data/get_finance?session_id=%@&=",apiUrl,sessionId];
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    //グーグルアナリティクス
    self.trackedViewName = @"moneyAdmin";
    ...
    if (buttonIndex == 1) {
        ...
        */
        ...
        AFHTTPRequestOperation *operation = [AFJSONRequestOperation JSONRequestOperationWithRequest:request success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
            ...
            NSArray *errorAcountTypeArray = [JSON valueForKeyPath:@"error.validations.Saving.account_type"];
            ...
            NSArray *drawingsArray = [JSON valueForKeyPath:@"error.validations.Saving.drawings"];
            ...
            NSArray *bankNameArray = [JSON valueForKeyPath:@"error.validations.Saving.bank_name"];
            ...
            NSArray *branchNameArray = [JSON valueForKeyPath:@"error.validations.Saving.branch_name"];
            ...
            NSArray *accountNameArray = [JSON valueForKeyPath:@"error.validations.Saving.account_name"];
            ...
            NSArray *accountNumberArray = [JSON valueForKeyPath:@"error.validations.Saving.account_number"];
            ...
            NSArray *passwordArray = [JSON valueForKeyPath:@"error.validations.Saving.password"];
