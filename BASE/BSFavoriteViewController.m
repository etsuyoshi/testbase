...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    AFHTTPRequestOperation *operation = [AFJSONRequestOperation JSONRequestOperationWithRequest:request success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
        NSLog(@"ログイン情報っっっっっっっっっっっっっｌ！: %@", JSON);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([BSDefaultViewObject isMoreIos7]) {
        ...
        AFImageRequestOperation *operation = [AFImageRequestOperation
                                              ...
                                              success:^(NSURLRequest *request, NSHTTPURLResponse *response, UIImage *getImage) {
                                                  NSLog(@"つうしんできてるよ");
                                                  [leftItemBtn setBackgroundImage:getImage forState:UIControlStateNormal];
        ...
        if ([indexPath row] * 2 + 1 <imageIdArray.count) {
            ...
            AFImageRequestOperation *operation = [AFImageRequestOperation
                                                  ...
                                                  success:^(NSURLRequest *request, NSHTTPURLResponse *response, UIImage *getImage) {
                                                      NSLog(@"つうしんできてるよ");
                                                      [rightItemBtn setBackgroundImage:getImage forState:UIControlStateNormal];
