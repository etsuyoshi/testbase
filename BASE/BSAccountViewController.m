...
- (void)viewDidLoad
{
    ...
    //グーグルアナリティクス
    self.trackedViewName = @"settingAccount";
...
- (void)changeAccountInfo:(id)sender{
    ...
    */
    ...
    AFHTTPRequestOperation *operation = [AFJSONRequestOperation JSONRequestOperationWithRequest:request success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
        NSLog(@"ユーザー情報変更！: %@", JSON);
        NSArray *mailValidationArray = [JSON valueForKeyPath:@"error.validations.User.mail_address"];
        ...
        NSArray *passwordValidationArray = [JSON valueForKeyPath:@"error.validations.User.pre_password"];
